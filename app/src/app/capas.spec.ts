 ...
 * fichero de verdad son 1.395 con ese subtipo y solo 1.236 vigentes.
 */
const RESERVAS = {
  type: 'FeatureCollection',
  features: [
...
describe('Capas — el regulado se filtra por tipo_actual', () => {
  ...
  /**
   * LA DECISIÓN DE LA CAPA DEL REGULADO. De los 7.424 tramos del censo, 6.217
   * son LIBRE y 30 no traen clasificación: **no son regulado y no se pintan**.
