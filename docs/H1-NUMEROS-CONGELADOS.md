...
> ⚠️ **ESTE DOCUMENTO PUBLICA 10 NÚMERO(S) SUPERADO(S).**
...
>
> <sub>las líneas CON nombre del mapa · las líneas rojas del mapa · las rojas explicadas por zona verde · las verdes SIN el listón de 1 ha · los km de rojo explicados por zona verde · las azules ANTES de la tanda 26 · las líneas a las que el motor les ve falta de nombre · las puertas que cuelgan de una línea sin nombre · las líneas decorativas — un ⛔ impreso que no para nada</sub>
<!-- SUPERADOS:FIN -->
