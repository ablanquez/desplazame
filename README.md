...
- **Seis familias, excluyentes**: andando, autobús/tranvía, bici, patín (VMP), moto y coche —y
  **ocho modos** detrás, porque **dos de las familias son dos**: la bici (privada y BiZi) y la moto
  (privada y la compartida de YeGo, desde el 5/09). Eran cuatro botones hasta el
  30/08, con la bici y el patinete juntos; los separó el motor, que desde la casilla 3 les aplica
  **tres tablas de acceso legales distintas**. Son un **grupo de radios** vestido de botones: seis
  pasan del rango del control segmentado —de 2 a 5 con etiqueta—, y con radios el teclado sale de
  serie (una parada de tabulador para el grupo y flechas entre las opciones).
- **Mapa con la ruta**.
...
> ℹ️ **Y las tres están en uso.** El notices lleva **una ficha por conjunto, y hoy son 38**
...
> recuadro algo que no es un conjunto de DATOS, sino la obra ajena que se pinta con ellos), y la
> ficha que declara lo que **todavía no** ha entrado.
>
...
> «treinta y siete» y ahora treinta y ocho**, y las tres primeras se quedaron viejas donde estaban. Es la entrada
...
> notices y las compara con el número que dice esta línea. Si no cuadran, la suite se pone roja.
>
> ⚠️ **Y el 10/09 se quedó vieja OTRA VEZ, dentro de esta misma frase.** El guardián del 1/09
> mira la cifra **en dígitos** del párrafo de arriba —«hoy son 37»—, y esa estaba bien. Esta
> crónica va **en letra** y en otra frase, así que quedaba fuera de su alcance: se paró en
> «treinta y cinco» (5/09) mientras el notices subía a treinta y seis (6/09) y a treinta y siete
> (7/09). La nº5 repitiéndose por tercera vez, y **justo dentro del párrafo que la cuenta** — el
> guardián no mentía, alcanzaba poco, que es exactamente lo que esa entrada dice. **Desde el
> 10/09 lee también esta crónica**: que acabe en el número de hoy, y que solo crezca.
>
> ⭐ **Y desde el 30/08 no todo «está dentro»: hoy son SEIS las que no se copian.** La
> disponibilidad del BiZi (§ 1.23), las llegadas al poste (§ 1.24), la ruta operativa de hoy
> (§ 1.25), la flota viva de YeGo (§ 1.34), el cuadro de horarios del festivo (§ 1.35) y el
> distintivo ambiental de una matrícula (§ 1.36) **se consultan** — caducan en segundos o en
> minutos, y guardarlas sería guardar una mentira con fecha. Cada una con su régimen, en la tabla
> de la cabecera del notices. ⚠️ **Esta línea decía TRES** —las tres del 30/08— mientras la
> cabecera del notices ya decía seis: el mismo documento contando dos cuentas distintas.
>
