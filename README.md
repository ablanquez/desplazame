...
> OpenStreetMap— y ya puede dibujar encima tres datos reales: los **46.150 portales** del
> Ayuntamiento de Zaragoza, las **98.774 aristas** del grafo de continuidad peatonal y
> ciclable, y los **733 tramos de carril bici** municipales, cada uno con su casilla para
> encenderlo y apagarlo. Pero el buscador **todavía no los usa**: la línea que dibuja al
> generar sigue siendo tan inventada como los pasos. No hay motor, y de las paradas y las
> estaciones Bizi no hay nada.
>
