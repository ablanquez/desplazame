...
| **Dónde está cumplida** | ⭐ **En la página de créditos, `/creditos`** (10/09): *«Horarios: GTFS del Punto de Acceso Nacional (MITMA) — Powered by MITRAMS (dato bruto y procesado)»*, con el enlace a `transportes.gob.es` puesto. ⚠️ **Estuvo en el pie del buscador del 1/09 al 10/09**, y se mudó cuando la franja se encogió a una línea: allí sólo se queda lo que la política de teselas de OSM obliga a tener sobre el mapa. A la página se llega **con un enlace fijo desde esa misma franja**, en todas las pantallas [RD 1495/2011: accesible «de forma permanente, fácil y directa»] — que es lo que impide que esta mudanza repita la de 2022, cuando la atribución se fue con el visor y la ficha siguió diciendo «cumplida». Las dos naturalezas son ciertas a la vez: la traza que se pinta es `shapes.txt` **tal cual**, cortada por paradas; los minutos se **calculan** sobre `stop_times`. ⚠️ **Y esta fila decía otra cosa que dejó de ser verdad el 22/08**: decía *«colgada de la capa de trazados: "Trazados: GTFS de Avanza Zaragoza S.A.U. (dato bruto) · Powered by MITRAMS"»*, y esa capa era del **visor**, que se retiró de la app ese día. Desde entonces y hasta hoy la ficha declaraba cumplida una atribución que **no estaba en ninguna pantalla** — comprobado el 01/09 con `grep -rn "Powered by\|MITRAMS" app/src/`, que no devolvía nada. Se corrige aquí en vez de reescribirla en silencio |
...
### 1.37 · Los treinta símbolos de Material — Google (`material-design-icons`)
...
| **¿Está en este repo?** | ✅ [`app/simbolos/`](app/simbolos/) · los treinta en **treinta y un ficheros** —de cada símbolo se guarda la instancia del eje óptico que de verdad se pinta, y `route` lleva dos porque se pinta a dos tamaños—, con [`PROCEDENCIA.md`](app/simbolos/PROCEDENCIA.md) y sus sha256 |
...
| `straight.svg` | 169 B | la maniobra **«recto»** | `d2b3959230c746d5832fff7b268dfeb5c2986ef94cf27252c875461cc940cf3a` |
| `turn_left.svg` | 199 B | la maniobra **«izquierda»** | `448795148db308e29fe5043fde3e4cabc8e28887062b98eebfa29821302f714d` |
| `turn_right.svg` | 200 B | la maniobra **«derecha»** | `5d3c7827e423aefb2608220aeb61ab8922421d04019f0a25a2756101f876b426` |
| `turn_slight_left.svg` | 188 B | la maniobra **«ligera-izquierda»** | `ca2a9e0ec3dddcce2352572527af1f55dcd0e6e6f4fa2e55f73819f862e68628` |
| `turn_slight_right.svg` | 188 B | la maniobra **«ligera-derecha»** | `70f1d8b06ec3cf9b9aee6ceb2e310aad9b06f29b914995be52c7c09b88cb2bc1` |
| `turn_sharp_left.svg` | 233 B | la maniobra **«cerrada-izquierda»** | `7edeb141c07f0dc05717765f16cfaa8005713d13c948d800dae4a25230779b67` |
| `turn_sharp_right.svg` | 232 B | la maniobra **«cerrada-derecha»** | `ecdce1c45702ea3413b159af683f831b6d23a44fa1ae4bd09950258e237708f6` |
| `u_turn_left.svg` | 258 B | la maniobra **«media-vuelta»** | `e3c8719cf7a5aa4eb689d3084978e52622c79ddc6150eca7933841d9fee95a35` |
| `trip_origin.svg` | 400 B | la maniobra **«salida»** | `445a5548e8a883b68cad23126b624b8915dd74e700504b37051467ca1e46d190` |
| `flag.svg` | 216 B | la maniobra **«llegada»** | `cab27088e64b22b34c43238070b14defc2485989e431e5a3dfea073638cca02b` |
| `local_parking.svg` | 244 B | la maniobra **«aparca»** | `edc2d006abb646c96eb493b2bcbbee1e05fba9d550afa56d32e4d87d70305456` |
| `transfer_within_a_station.svg` | 494 B | la maniobra **«transborda»** | `ef6907f8dd11e30f786253656d2496a531d47bec8b1ce2a0a17002b4d9bc5ab0` |
...
⚠️ **El dibujo vive en DOS sitios, y la copia tiene portero.** Un `<img>` no
hereda el color del texto y los chips cambian de tinta con su estado, así que el
`path` se inyecta en línea —`fill="currentColor"`— desde una tabla en
[`app/src/app/simbolos.ts`](app/src/app/simbolos.ts). Eso obliga a tener el `d`
